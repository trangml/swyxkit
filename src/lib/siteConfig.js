...
export const MY_TWITTER_HANDLE = '_trangml';
export const MY_YOUTUBE = 'https://youtube.com/@trangML';
export const POST_CATEGORIES = ['Essay', 'Misc', 'DevLog']; // Other categories you can consider adding: Talks, Tutorials, Snippets, Podcasts, Notes...
